    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html "
                ...
                <span class="ms-1 font-weight-bold">Perpustakaan Digital</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link {{ request()->path() == 'dashboard.dashboard' ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->path() == 'borrow.index' ? 'active' : '' }}" href="/borrow">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->path() == 'collection.index' ? 'active' : '' }}" href="/collection">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-calendar-grid-58 text-warning text-sm opacity-10"></i>
                        </div>
                ...
                <li class="nav-item {{ request()->path() == 'signUp' ? 'active' : '' }}">
        ...
        <div class="sidenav-footer mx-3 ">
            <div class="card card-plain shadow-none" id="sidenavCard">
                <img class="w-50 mx-auto" src="{{ url('assets/img/illustrations/icon-documentation.svg') }}"
